...
#
# Script generated by Vivado on Mon Sep 29 17:59:40 PDT 2025
# SW Build 3865809 on Sun May  7 15:04:56 MDT 2023
#
# Tool Version Limit: 2023.05 
#
# Filename     : axi_vip_2.sh
...
#
# Usage        : axi_vip_2.sh
#                axi_vip_2.sh [-lib_map_path] [-step] [-keep_index] [-noclean_files]*
#                axi_vip_2.sh [-reset_run]
#                axi_vip_2.sh [-reset_log]
#                axi_vip_2.sh [-help]
#
...
#                script (type 'axi_vip_2.sh -help' for more information).
#
...
design_libs_elab="-libname xilinx_vip -libname axi_infrastructure_v1_1_0 -libname xil_defaultlib -libname axi_vip_v1_1_14 -libname xilinx_vip -libname unisims_ver -libname unimacro_ver -libname secureip"

# set design libraries
design_libs=(simprims_ver xilinx_vip axi_infrastructure_v1_1_0 xil_defaultlib axi_vip_v1_1_14)

# simulation root library directory
sim_lib_dir="xcelium_lib"

# script info
echo -e "axi_vip_2.sh - Script generated by export_simulation (Vivado v2023.1 (64-bit)-id)\n"
...
run()
{
  ...
  if [[ ($b_step == 1) ]]; then
    case $step in
      ...
      ;;
      * )
        echo -e "ERROR: Invalid or missing step '$step' (type \"./axi_vip_2.sh -help\" for more information)\n"
        exit 1
      esac
  else
    init_lib
...
compile()
{
  xmvlog -work xilinx_vip $xmvlog_opts -sv +incdir+"$ref_dir/../../../ipstatic/hdl" +incdir+"../../../ipstatic/hdl" +incdir+"/usr/local/Vivado/2023.1/data/xilinx_vip/include" \
  ...
  xmvlog -work axi_infrastructure_v1_1_0 $xmvlog_opts +incdir+"$ref_dir/../../../ipstatic/hdl" +incdir+"../../../ipstatic/hdl" +incdir+"/usr/local/Vivado/2023.1/data/xilinx_vip/include" \
  "../../../ipstatic/hdl/axi_infrastructure_v1_1_vl_rfs.v" \
  2>&1 | tee -a compile.log; cat .tmp_log >> xmvlog.log 2>/dev/null

  xmvlog -work xil_defaultlib $xmvlog_opts -sv +incdir+"$ref_dir/../../../ipstatic/hdl" +incdir+"../../../ipstatic/hdl" +incdir+"/usr/local/Vivado/2023.1/data/xilinx_vip/include" \
  "../../../ip/axi_vip_2/sim/axi_vip_2_pkg.sv" \
  2>&1 | tee -a compile.log; cat .tmp_log >> xmvlog.log 2>/dev/null

  xmvlog -work axi_vip_v1_1_14 $xmvlog_opts -sv +incdir+"$ref_dir/../../../ipstatic/hdl" +incdir+"../../../ipstatic/hdl" +incdir+"/usr/local/Vivado/2023.1/data/xilinx_vip/include" \
...
elaborate()
{
  xmelab $xmelab_opts $design_libs_elab xil_defaultlib.axi_vip_2 xil_defaultlib.glbl
}

# RUN_STEP: <simulate>
simulate()
{
  xmsim $xmsim_opts xil_defaultlib.axi_vip_2 -input simulate.do
}
...
create_lib_mappings()
{
  ...
  if [[ ($lib_map_path == "") ]]; then
    lib_map_path="/home/hrlclinic/Documents/troy_axi_sig_gen/axi_sig_gen_testing_fr/axi_sig_gen_testing_fr.cache/compile_simlib/xcelium"
  fi
...
reset_run()
{
  files_to_remove=(xmvlog.log xmvhdl.log xmsc.log compile.log elaborate.log simulate.log diag_report.log xsc_report.log axi_vip_2_sc.so .tmp_log xcelium_lib waves.shm c.obj)
...
check_arg_value()
{
  ...
  if [[ ($1 == "-lib_map_path") && ($2 == "") ]];then
    echo -e "ERROR: Simulation library directory path not specified (type \"./axi_vip_2.sh -help\" for more information)\n"
    exit 1
  fi
}
...
usage()
{
  msg="Usage: axi_vip_2.sh [-help]\n\
Usage: axi_vip_2.sh [-step]\n\
Usage: axi_vip_2.sh [-lib_map_path]\n\
Usage: axi_vip_2.sh [-reset_run]\n\
Usage: axi_vip_2.sh [-reset_log]\n\
Usage: axi_vip_2.sh [-keep_index]\n\
Usage: axi_vip_2.sh [-noclean_files]\n\n\
